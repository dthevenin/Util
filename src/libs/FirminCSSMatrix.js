...
class FirminCSSMatrix {
  ...
  constructor (domstr) {
    ...
    if (typeof domstr == "string") this.setMatrixValue(domstr)
  }
   ...
   **/
  static determinant3x3 (a1, a2, a3, b1, b2, b3, c1, c2, c3) {
...
[["m11", "a"],
 ...
 ["m41", "e"],
 ["m42", "f"]].forEach(pair => {
  let [key3d, key2d] = pair

  Object.defineProperty(FirminCSSMatrix.prototype, key2d, {
    set: function(val) { this[key3d] = val },
    get: function() { return this[key3d] }
  });
});
